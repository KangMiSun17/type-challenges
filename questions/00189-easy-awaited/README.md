...
- [이슈](https://github.com/type-challenges/type-challenges/issues/18837)
- [해설](https://ghaiklor.github.io/type-challenges-solutions/ko/easy-awaited.html)

Answer

```ts
type MyAwaited = T extends PromiseLike<infer U> ? MyAwaited<U> : T
```
